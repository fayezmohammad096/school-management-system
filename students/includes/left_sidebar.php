...
<!--//down-->
 <div class="menu">
	<ul id="menu" >
		...
		<li id="menu-academico" ><a href="all_students.php"><i class="fa fa-users"></i> <span> Students</span> <span class="fa fa-angle-right" style="float: right"></span></a>
			<ul id="menu-academico-sub" >
				<li id="menu-academico-avaliacoes" ><a href="add_student.php">INSERT STUDENTS</a></li>
				<li id="menu-academico-avaliacoes" ><a href="all_students.php"> All STUDENTS</a></li>
				<li id="menu-academico-boletim" ><a href="Update student">Update STUDENTS</a></li>
			</ul></li>

		<li id="menu-academico" ><a href="teachers.php"><i class="fa fa-users"></i> <span> Teachers</span> <span class="fa fa-angle-right" style="float: right"></span></a></li>								<li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Tabs &amp; Panels</span> <span class="fa fa-angle-right" style="float: right"></span></a>
			<ul id="menu-academico-sub" >
		<li id="menu-academico-avaliacoes" ><a href="tabs.html"> ADD TEACHERS</a></li>
		<li id="menu-academico-boletim" ><a href="widget.html">ALL TEACHERS</a></li>
